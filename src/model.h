...
public:
    ...
    int init(int *i, int *j, int *v, int total, double *delta, int *Z, double *Phi, int init, int K0, double* refBeta);
    ...
    void estimate(double* refBeta);
    void inference();
    int sampling(int m, int n);
    int get_wordassign(int m, int n);
    void compute_theta();
    void compute_phi(double* refBeta);
